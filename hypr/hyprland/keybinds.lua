...
hl.bind(vars.kbShrinkWinY, fn.resize_active_window(0, -8), { repeating = true })
hl.bind(vars.kbGrowWinY, fn.resize_active_window(0, 8), { repeating = true })

hl.bind(vars.kbShrinkWinXArrow, fn.resize_active_window(-8, 0), { repeating = true })
hl.bind(vars.kbGrowWinXArrow, fn.resize_active_window(8, 0), { repeating = true })
hl.bind(vars.kbShrinkWinYArrow, fn.resize_active_window(0, -8), { repeating = true })
hl.bind(vars.kbGrowWinYArrow, fn.resize_active_window(0, 8), { repeating = true })
